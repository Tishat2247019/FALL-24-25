...
url <- "https://www.livejournal.com/support/faq/cat/comments.html#:~:text=Most%20comment%20options%2C%20including%20comment,friends%22%20next%20to%20Enable%20comments."
...
headlines <- webpage %>%
  html_elements(".b-supportpage-solutions-head a") %>%  # Example CSS selector
  html_text()
