...
# url <- "https://www.trustpilot.com/review/gullwingmotor.com"
...
headlines <- webpage %>%
  html_elements(".typography_color-black__wpn7m") %>%  # Example CSS selector
  html_text()
...
# Filter exactly 10 terms per topic
