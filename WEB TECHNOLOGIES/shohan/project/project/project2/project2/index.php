...
<body>
    <div class="main_container">
        ...
        <div class="container">
            <div class="header">
                <div class="logo_left">
                    <div class="ad">
                        <img src="./asset/images/SVG/ad.svg" alt="">
                    </div>
                    <div class="adventure">
                        <img src="./asset/images/SVG/adventure.svg" alt="">
                    </div>
                </div>


                <div class="buttons_header">
                    <a href="./view/auth_feature/signup.html">
                        <button>SIGN UP</button>
                    </a>
                    <a href="./view/auth_feature/signin.html">
            ...
            <div class="category_container">
                    <div class="text_container_cat">
                        <h1>Browse <span><img src="./asset/images/SVG/white_ad.svg" alt="" >
                        </span>by Category </h1>
                    </div>
                    <ul>
    ...
    <script>
        // Wait for the animation to complete before showing the home page
        setTimeout(function () {
