        ...
        <div class="container">
            ...
            <div class="menu_links">
                ...
                <li><a href="../dashboard/user_db.php?id=<?php echo $idd;  ?>">Dashboard</a></li>
                    ...
                    <li><a href="../profile/edit_profile.php">Edit Profile</a></li>
                    <li><a href="../profile/cng_profile_pic.php">Change Profile Photo</a></li>
                    <li><a href="../profile/cng_pass.php">Change Password</a></li>
